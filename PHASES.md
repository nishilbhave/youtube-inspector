...
- [ ] **Output parity check:** run yt-verdict on the same URL in Claude Code and Cursor. Acceptance: same WATCH/OKAY/SKIP verdict, same flag count ±1, same evidence-quality bar (verbatim quotes + timestamps).
