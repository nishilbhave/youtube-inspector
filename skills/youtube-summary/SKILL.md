...
If it exits non-zero, surface the printed `pipx install` command verbatim to the user, ask them to run it, and **stop**. Do not retry the fetch until the user confirms the install succeeded.
